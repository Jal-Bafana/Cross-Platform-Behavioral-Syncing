...
import { Github, Youtube, BookOpen, MessageSquare, CheckCircle, AlertCircle, Loader2, Zap } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-gold">{totalActivities}</div>
                ...
                {platform.connected ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      className="w-full glass-button bg-gradient-to-r from-purple-500/20 to-gold/20 hover:from-purple-500/40 hover:to-gold/40 border-purple-500/50"
                    >
                      {platform.syncing ? (
                        <>
