  ...
  const knowledgeNodes: KnowledgeNode[] = [
    {
      ...
      category: "Frontend",
      strength: 95,
      connections: ["typescript", "javascript", "nextjs"],
    ...
    },
    {
      ...
      category: "Language",
      strength: 88,
      connections: ["react", "nodejs", "javascript"],
        ...
        <div className="relative h-64 mb-6 glass-card p-4 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <motion.div
              ...
              className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-500 to-gold flex items-center justify-center pulse-glow"
            >
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3 p-3 glass-card">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Your React and TypeScript skills are highly developed</div>
            </div>
          </div>
