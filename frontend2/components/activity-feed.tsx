...
import { Github, Youtube, BookOpen, MessageSquare, Clock, TrendingUp, Star, GitCommit, Play, Award } from "lucide-react"
...
export function ActivityFeed() {
  const activities: Activity[] = [
    ...
    },
    {
      ...
      description: "Provided detailed answer about useMemo and useCallback",
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-gold flex items-center justify-center">
