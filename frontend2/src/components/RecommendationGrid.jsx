...
export function RecommendationGrid({ filters }) {
  const recommendations = [
    ...
    },
    {
      ...
      description:
        "Comprehensive JavaScript guide covering latest features, design patterns, and real-world applications matching your coding style.",
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2 pt-2">
                  <Button
                    size="sm"
                    className="flex-1 glass-button bg-gradient-to-r from-purple-500/20 to-yellow-400/20 hover:from-purple-500/40 hover:to-yellow-400/40 border-purple-500/50 text-white"
                  >
      ...
      {filteredRecommendations.length === 0 && (
        ...
        >
          <div className="glass-card p-8 max-w-md mx-auto">
            <div className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-500/20 to-yellow-400/20 flex items-center justify-center mx-auto mb-4">
